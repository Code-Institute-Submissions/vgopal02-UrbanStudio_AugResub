...
-   ## Design
    ...
    -   #### Color Scheme
       Colors have been inspired by the brand logo ( tree of life) and  color palletes obtained from [colorcombos](https://www.colorcombos.com).
       <br>
...
-   The brand words "Urban Studio" on the header returns the user  to home page. 
...
-   ## Color Scheme 
     - The color scheme used has remained consistent through the site . 
     ...
     - Yoga,Pilates,Meditation section box background and Contact Us Page:rgb(202, 209, 190,0.4) and rgb(245, 218, 223,0.4).
     - Opacity has been added to ensure the fonts are clearly visible. 
<br>
<br>
